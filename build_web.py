...
<style>
  * {{
  ...
  .dt-btn:hover {{
    background: #00e650;
    color: #040608;
    box-shadow: 0 0 15px #00e650;
  }}
  .dt-btn.real-term {{
    border-color: #ffd228;
    color: #ffd228;
  }}
  .dt-btn.real-term:hover {{
    background: #ffd228;
    color: #040608;
    box-shadow: 0 0 15px #ffd228;
  }}
</style>
</head>
<body>
...
<div id="desktop-container">
  ...
  <!-- Initial Desktop Verification / Launcher Dialog -->
  <div id="desktop-launcher">
    ...
    <div class="dt-row">&gt; DISPLAY SUBSYSTEM: <span class="ok">[OK] FULL RESOLUTION READY</span></div>
    <div class="dt-row">&gt; MEME PAYLOADS: <span class="ok">[OK] 18 ASSETS DETECTED</span></div>
    <div class="dt-row">&gt; STATUS: READY FOR LAUNCH</div>
...
window.addEventListener("DOMContentLoaded", () => {{
  ...
  if (device === "iphone") {{
    ...
    document.getElementById("btn-real-term").addEventListener("click", () => {{
      triggerRealTerminalDownload();
    }});

    document.getElementById("btn-web-term").addEventListener("click", () => {{
